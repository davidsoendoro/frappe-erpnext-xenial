...
def get_passwords(ignore_prompt=False, mysql_root_password='', admin_password=''):
...
def parse_commandline_args():
	...
	parser.add_argument('--mysql-root-password', dest='mysql_root_password', 
		help='MySQL root password for this installation', default='')

	parser.add_argument('--admin-password', dest='admin_password', help='Admin password for this installation', 
		default='')
